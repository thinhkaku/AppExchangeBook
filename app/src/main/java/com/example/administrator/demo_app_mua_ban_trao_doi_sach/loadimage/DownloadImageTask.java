package com.example.administrator.demo_app_mua_ban_trao_doi_sach.loadimage;
...
public class DownloadImageTask extends AsyncTask<String, Void, Bitmap> {
    ...
    public DownloadImageTask(Context context, ImageView destination, String url)
    {
        ...
        FrameLayout.LayoutParams copy = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
